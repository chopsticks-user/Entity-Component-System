...
public:
  ...
  //   std::apply(
  //       [&](auto &&...args) {
  //         m_componentTable.template
  //         addEntityWith<T_Components...>(entity.id(),
  //                                                                  args...);
  //       },
  //       componentTuple);
  ...
  // template <IsComponent... T_Components> //
  // [[nodiscard]] constexpr auto create(u64 nEntities, T_Components...
  // components)
  //     -> std::vector<T_Entity> {
  ...
  //   auto newSignature = signatureOf(entityID) |
  ...
  // template <IsComponent... T_Components> //
  // constexpr auto removeComponentsOf(const EntityID &entityID) noexcept ->
  // void {
  //   if (!m_entityManager.contains(entityID)) {
  //     return;
  //   }
